...
export default function Footer() {
    return (
        ...
        <div id="footer-right">
            ...
            <a target="_blank" href="https://bestwall2.github.io/BOXSTREAM/" rel="noopener noreferrer"><i className="fa-brands fa-github" style={{color: "#ffffff"}} id="github" alt="Github Icon"></i></a>
        </div>
    </div>
    )
}